    ...
    <div>
        <div class="d-flex justify-content-between mt-3">
            <div class="div">
                ...
                <h3 class="text-center fw-bold color-primary">Gallery</h3>
            </div>
            <div class="div">
                            ...
                            <tbody>
                                @foreach ($data as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <img class="img-fluid img-gallery-admin" 
                            ...
                            <div class="d-flex justify-content-between flex-wrap">
                                ...
                                <div class="col-12 mb-3">
                                    <label for="Gambar" class="form-label ">image <small>(Max
                                            4MB)</small> </label><br>
                                    <img class="img-fluid mb-2" style="height: 130px" src="{{ asset('image/gallery/' . $image) }}"
                                        alt="">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between flex-wrap">
                        ...
                        <div class="col-12 mb-3">
                            <label for="Gambar" class="form-label ">image <small>(Max
                                    4MB)</small> </label>
                            <input required wire:model.defer="image" type="file" class="form-control">
                            <div class="text-danger" wire:loading wire:target="image">
                                Uploading...
                            </div>
                            @error('image')
                                <div class="text-danger">{{ $message }}</div>
