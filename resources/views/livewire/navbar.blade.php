                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 ">
                    <li class="nav-item">
                        @if (request()->routeIs('index'))
                            <a class="nav-link text-center text-lg-start active text-header" aria-current="page" href="#home">Home</a>
                        @else
                            <a class="nav-link text-center text-lg-start  text-header" aria-current="page" href="/">Home</a>
                        @endif
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-center text-lg-start  text-header" aria-current="page" href="{{ route('index') }}#faq">Help
                            Centre</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-center text-lg-start  text-header" aria-current="page" href="{{ route('index') }}#contact">Contact
                            Us</a>
                    </li>
                    <li class="nav-item">
