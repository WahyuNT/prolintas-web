                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="card bg-secondary text-center p-1 "
                                            ...
                                            <img class="img-fluid" src="{{ asset('image/services/' . $item->image) }}"
                                                alt="">
                                        </div>
                                    </td>
                                    <td>{{ $item->title }}</td>
                        ...
                        <div class="d-flex justify-content-between flex-wrap">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <div class="card bg-secondary text-center p-1 " style="height: 60px;width: 60px;">
                                    <img class="img-fluid" src="{{ asset('image/services/' . $image) }}"
                                        alt="">

                                </div>
                                <input required wire:model="image_baru" type="file" class="form-control">
        ...
        @else
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between flex-wrap">
                    ...
                    <div class="col-12 mb-3">
                        <label for="Gambar" class="form-label text-muted">image <small>(Max
                                4MB)</small> </label>
